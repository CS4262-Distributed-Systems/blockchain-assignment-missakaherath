...
public final class AssetTransfer implements ContractInterface {
     ...
     * @param newtID the ID of the asset duplicated asset
     * @param owner the owner of the asset being duplicated
     * @return the duplicated asset
     */
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newtID, final String owner) {
        Asset origAsset = ReadAsset(ctx, assetID);
        return CreateAsset(ctx, newtID, origAsset.getColor(), origAsset.getSize(),
